...
export interface TegalsariProfile {
  title: string;
  subtitle: string;
  hero_image: string;
  description: string;
...
export interface AppSetting {
  ...
  // Marketing & Perijinan Submenu Content (Admin Editable)
  marketing_nib_content?: string;
  marketing_nib_image?: string;
  marketing_pirt_content?: string;
  marketing_pirt_image?: string;
  marketing_halal_content?: string;
  marketing_halal_image?: string;
  marketing_pelatihan_content?: string;
  marketing_pelatihan_image?: string;
  marketing_whatsapp_content?: string;
  marketing_whatsapp_image?: string;
}
