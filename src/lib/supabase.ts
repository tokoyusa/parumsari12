...
const INITIAL_SETTINGS: AppSetting = {
  ...
  pakasir_api_key: 'rE24cpoGsJwlDvQ3AnFMRX9SgZsGaVDE',
  pakasir_merchant_id: 'pasar-tegalsari',
  ...
  // Default values for marketing and perijinan submenu content
  marketing_nib_content: `### Nomor Induk Berusaha (NIB)

Nomor Induk Berusaha (NIB) adalah identitas pelaku usaha yang diterbitkan oleh Lembaga OSS (Online Single Submission). NIB wajib dimiliki oleh seluruh pelaku UMKM di Desa Tegalsari sebagai langkah awal legalitas usaha.

#### Manfaat Memiliki NIB:
1. Memperoleh legalitas hukum usaha secara resmi.
2. Mempermudah akses pembiayaan perbankan (KUR).
3. Kesempatan mengikuti program pelatihan dan bantuan gratis dari pemerintah.

#### Cara Pendaftaran Mandiri:
Silakan kunjungi website resmi [OSS Indonesia](https://oss.go.id) atau hubungi Kantor Desa Tegalsari untuk pendampingan pendaftaran gratis.`,
  marketing_nib_image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=600',
  
  marketing_pirt_content: `### Sertifikat Produksi Pangan Industri Rumah Tangga (SPP-PIRT)

Sertifikat PIRT merupakan jaminan tertulis yang diberikan oleh Bupati/Walikota melalui Dinas Kesehatan terhadap pangan hasil produksi Industri Rumah Tangga yang memenuhi standar keamanan pangan.

#### Pentingnya PIRT untuk UMKM Kuliner:
1. Produk makanan/minuman dapat dipasarkan secara luas di toko retail modern.
2. Meningkatkan kepercayaan konsumen terhadap kebersihan dan kualitas produk.
3. Memenuhi regulasi hukum peredaran produk pangan olahan.

#### Cara Pengajuan:
Pelaku usaha dapat mengajukan SPP-PIRT secara online terintegrasi melalui sistem OSS, dilanjutkan dengan mengikuti Penyuluhan Keamanan Pangan (PKP) oleh Dinas Kesehatan.`,
  marketing_pirt_image: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&q=80&w=600',
  
  marketing_halal_content: `### Sertifikasi Halal Indonesia

Berdasarkan undang-undang, produk yang masuk, beredar, dan diperdagangkan di wilayah Indonesia wajib bersertifikat halal. Bagi pelaku UMKM Tegalsari, terdapat program Sertifikasi Halal Gratis (SEHATI) melalui mekanisme self-declare.

#### Mengapa Harus Bersertifikat Halal?
1. Menjamin ketenteraman batin konsumen Muslim.
2. Produk memiliki nilai jual lebih tinggi dan daya saing pasar global.
3. Menjadi syarat mutlak untuk masuk ke pusat perbelanjaan modern.

#### Program Sertifikasi Gratis (SEHATI):
Informasi kuota gratis dan tata cara pengajuan dapat diperoleh melalui Pendamping Proses Produk Halal (P3H) di Kecamatan Tegalsari atau tanyakan langsung pada Admin Desa.`,
  marketing_halal_image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&q=80&w=600',
  
  marketing_pelatihan_content: `### Info Pelatihan UMKM Tegalsari

Kami secara berkala mengadakan pelatihan digitalisasi, teknik pengemasan (packaging) kreatif, strategi pemasaran media sosial, serta manajemen keuangan mandiri untuk warga Desa Tegalsari.

#### Jadwal Pelatihan Terdekat:
- **Materi**: Penggunaan 'Marketing Tool' PARUMSARI untuk Foto Produk Estetik.
- **Waktu**: Setiap Sabtu pukul 09:00 WIB.
- **Tempat**: Balai Pertemuan Desa Tegalsari.
- **Fasilitator**: Tim Penggerak Digital Desa Tegalsari & Pemuda Pelopor.`,
  marketing_pelatihan_image: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&q=80&w=600',
  
  marketing_whatsapp_content: `### Hubungi Grup WhatsApp Paguyuban UMKM Tegalsari

Mari bergabung bersama ratusan pelaku usaha mikro se-Desa Tegalsari di Grup WhatsApp Paguyuban. Di grup ini, kita berbagi info pasar, tips jualan laris, koordinasi pengantaran paket kurir, serta bantuan modal usaha.

#### Link Gabung Grup WhatsApp Resmi:
Silakan klik link berikut untuk bergabung langsung dari handphone Anda:

👉 [**Grup WhatsApp UMKM Tegalsari**](https://chat.whatsapp.com/ExampleGroupTegalsari)

*Catatan: Grup ini khusus diperuntukkan bagi warga Desa Tegalsari yang memiliki usaha aktif.*`,
  marketing_whatsapp_image: 'https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?auto=format&fit=crop&q=80&w=600'
};
...
export const db = {
  ...
  parseAppSettings(settings: any): AppSetting {
    ...
    if (parsedSettings.tegalsari_profile) {
      parsedSettings.tegalsari_profile = {
        ...INITIAL_SETTINGS.tegalsari_profile,
        ...parsedSettings.tegalsari_profile
      };
    } else {
      parsedSettings.tegalsari_profile = INITIAL_SETTINGS.tegalsari_profile;
    }
    ...
    if (tagStartIndex !== -1) {
      ...
      if (lastBracketIndex > tagContentStart) {
        ...
        try {
          ...
          if (extra.tegalsari_profile) {
            extra.tegalsari_profile = {
              ...INITIAL_SETTINGS.tegalsari_profile,
              ...extra.tegalsari_profile
            };
          }
    ...
    if (isSupabaseConfigured && supabase) {
      ...
      const getFallbackPayload = () => {
        const extraKeysObj = {
          ...
          tegalsari_profile: mergedHydrated.tegalsari_profile,
          marketing_nib_content: mergedHydrated.marketing_nib_content,
          marketing_nib_image: mergedHydrated.marketing_nib_image,
          marketing_pirt_content: mergedHydrated.marketing_pirt_content,
          marketing_pirt_image: mergedHydrated.marketing_pirt_image,
          marketing_halal_content: mergedHydrated.marketing_halal_content,
          marketing_halal_image: mergedHydrated.marketing_halal_image,
